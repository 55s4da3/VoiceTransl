...
TRANSLATIONS = {
    "zh": {
        ...
        "lan_address": "地址：{address}:{port}",
        "lan_pair_code": "配对码：{code}",
        "lan_restart": "启动/重启服务",
        ...
        "progress_phase_files": "处理文件",
        "progress_phase_input": "输入准备",
        "progress_phase_download": "下载输入",
        "progress_phase_audio": "音频提取",
        "progress_phase_split": "音频切分",
        "progress_phase_transcribe": "识别与对齐",
        "progress_phase_merge": "片段合并",
        "progress_phase_resegment": "AI 断句",
        "progress_phase_subtitle": "字幕生成",
        "progress_phase_translation": "翻译与校对",
        "progress_phase_output": "最终输出",
        "progress_phase_separate": "人声分离",
        "progress_phase_summarize": "字幕总结",
        "progress_phase_synth": "视频合成",
        "progress_phase_clip": "视频剪辑",
        "progress_phase_clean": "缓存清理",
        "progress_phase_api": "API 测试",
        "status_ai_resegment_done": "[INFO] AI 断句整理完成，共 {count} 条。",
        "status_ai_resegment_failed": "[WARN] AI 断句响应无效，已保留原断句：{error}",
        "status_ai_resegment_unchanged": "[WARN] AI 返回了与原文相同的分组，未生成 .resegmented 文件。",
        ...
        "adv_ai_resegment_model_label": "🧩 AI 全量断句模型：",
        "adv_proofread_model_label": "✅ 全量校对模型：",
        "adv_auxiliary_models_label": "🧰 辅助流程模型配置：",
        "tip_auxiliary_profiles": "AI 全量断句和全量校对可分别跟随主翻译，或独立选择服务商、模型、API Key 与地址。",
        "aux_profile_follow_main": "跟随主翻译配置",
        "aux_profile_custom": "custom（自定义模型）",
        "aux_profile_provider_label": "服务商：",
        "aux_profile_model_label": "模型名称：",
        "aux_profile_token_label": "API Key：",
        "aux_profile_address_label": "API 地址：",
        "aux_profile_token_placeholder": "留空时使用主翻译 API Key",
        "aux_profile_custom_address_placeholder": "输入 OpenAI 兼容 API 地址",
        "aux_profile_test_btn": "测试此配置并加载模型列表",
        "tip_auxiliary_model_detail": "二级菜单：选择具体型号；自定义模式下可直接输入模型名称。",
        "tip_ai_resegment_model": "AI断句通常使用Flash即可；复杂长文本可改用Pro。",
        "tip_proofread_model": "全量校对更看重准确性，建议使用Pro；追求速度可用Flash。",
        "adv_deepseek_thinking": "主翻译启用思考模式",
        "tip_deepseek_thinking": "只控制主翻译当前模型的思考/推理请求；会增加耗时与 Token 消耗。",
        "aux_profile_thinking": "启用思考模式",
        "tip_aux_profile_thinking": "只控制当前辅助流程；不支持思考的模型无法启用此开关。",
        "dialog_model_target_label": "将所选模型用于：",
        "dialog_model_target_translation": "主翻译",
        "dialog_model_target_resegment": "AI 全量断句",
        "dialog_model_target_proofread": "全量校对",
        "adv_concurrency_label": "最大并发数（0为串行，1以上为并发）：",
        "adv_online_token_label": "🚀 在线模型令牌",
        "adv_translator_mode_online": "在线 API",
        "adv_translator_mode_local": "本地模型",
        ...
        "offline_test_requires_crispasr": "离线听写自检当前仅支持 CrispASR",
        ...
        "status_aux_models_loaded": "[INFO] 已加载 {count} 个模型，请在对应的模型名称下拉框中选择。",
        "status_api_models_truncated": "[WARN] 接口返回 {total} 个模型，为避免界面卡顿仅加载前 {limit} 个；仍可手动输入模型名。",
        ...
        # === ASRLabs Integration ===
        "settings_asr_provider_label": "🧩 识别提供方",
        "settings_asr_provider_asrlabs": "ASRLabs（PyTorch / HuggingFace）",
        "settings_asr_provider_crispasr": "CrispASR（本地 GGUF）",
        ...
        "settings_crispasr_backend_label": "🧠 CrispASR 后端",
        "settings_crispasr_model_label": "📦 CrispASR 识别模型（GGUF）",
        "settings_crispasr_aligner_label": "⏱️ CrispASR 强制对齐模型（GGUF）",
        "settings_crispasr_param_label": "🔧 CrispASR 命令模板",
        "settings_crispasr_param_placeholder": "支持占位符：$crispasr_executable、$backend、$model_file、$aligner_file、$language、$output_file、$input_file",
        "settings_open_crispasr_btn": "📁 打开 CrispASR 目录",
        "settings_refresh_crispasr_btn": "🔄 刷新 CrispASR 列表",
        "status_crispasr_transcribing": "[INFO] [CrispASR] 正在识别：{backend} -> {audio}",
        "status_crispasr_done": "[INFO] [CrispASR] 识别和对齐完成：{output}",
        "status_crispasr_error": "[ERROR] [CrispASR] 处理失败：{error}",
        "status_crispasr_param_save_error": "[WARN] [CrispASR] 无法保存命令模板，将继续使用当前设置：{error}",
    },
    "en": {
        "lan_title": "PixelPlayer LAN Connection",
        "lan_enabled": "Enable LAN service",
        ...
        "lan_address": "Address: {address}:{port}",
        "lan_pair_code": "Pairing code: {code}",
        "lan_restart": "Start/restart service",
        ...
        "progress_phase_files": "Files",
        "progress_phase_input": "Input preparation",
        "progress_phase_download": "Download input",
        "progress_phase_audio": "Audio extraction",
        "progress_phase_split": "Audio splitting",
        "progress_phase_transcribe": "Transcription and alignment",
        "progress_phase_merge": "Segment merging",
        "progress_phase_resegment": "AI segmentation",
        "progress_phase_subtitle": "Subtitle generation",
        "progress_phase_translation": "Translation and proofreading",
        "progress_phase_output": "Final output",
        "progress_phase_separate": "Vocal separation",
        "progress_phase_summarize": "Subtitle summary",
        "progress_phase_synth": "Video synthesis",
        "progress_phase_clip": "Video clipping",
        "progress_phase_clean": "Cache cleanup",
        "progress_phase_api": "API test",
        "status_ai_resegment_done": "[INFO] AI sentence restructuring completed with {count} entries.",
        "status_ai_resegment_failed": "[WARN] The AI segmentation response was invalid; original boundaries were kept: {error}",
        "status_ai_resegment_unchanged": "[WARN] AI returned the original grouping; no .resegmented file was created.",
        ...
        "adv_ai_resegment_model_label": "🧩 Full-file resegmentation model:",
        "adv_proofread_model_label": "✅ Full proofreading model:",
        "adv_auxiliary_models_label": "🧰 Auxiliary process models:",
        "tip_auxiliary_profiles": "Full-file resegmentation and proofreading can follow the main translator or use an independent provider, model, API key, and endpoint.",
        "aux_profile_follow_main": "Follow main translation",
        "aux_profile_custom": "custom (OpenAI-compatible)",
        "aux_profile_provider_label": "Provider:",
        "aux_profile_model_label": "Model:",
        "aux_profile_token_label": "API key:",
        "aux_profile_address_label": "Endpoint:",
        "aux_profile_token_placeholder": "Leave blank to use the main API key",
        "aux_profile_custom_address_placeholder": "Enter an OpenAI-compatible endpoint",
        "aux_profile_test_btn": "Test this profile and load models",
        "tip_auxiliary_model_detail": "Second level: choose the exact model; custom mode also accepts typed model names.",
        "tip_ai_resegment_model": "Flash is usually enough for resegmentation; use Pro for difficult long transcripts.",
        "tip_proofread_model": "Pro is recommended for proofreading accuracy; choose Flash when speed matters more.",
        "adv_deepseek_thinking": "Thinking mode for main translation",
        "tip_deepseek_thinking": "Controls reasoning requests for the current main model; this increases latency and token usage.",
        "aux_profile_thinking": "Enable thinking mode",
        "tip_aux_profile_thinking": "Controls only this auxiliary process; models without thinking support cannot enable it.",
        "dialog_model_target_label": "Use the selected model for:",
        "dialog_model_target_translation": "Main translation",
        "dialog_model_target_resegment": "Full-file resegmentation",
        "dialog_model_target_proofread": "Full proofreading",
        "adv_concurrency_label": "Max concurrency (0=serial, 1+=concurrent):",
        "adv_online_token_label": "🚀 Online Model Token",
        "adv_translator_mode_online": "Online API",
        "adv_translator_mode_local": "Local Model",
        ...
        "offline_test_requires_crispasr": "The offline transcription self-test currently requires CrispASR",
        ...
        "status_aux_models_loaded": "[INFO] Loaded {count} model(s); choose one from the corresponding model field.",
        "status_api_models_truncated": "[WARN] The API returned {total} models. Only the first {limit} were loaded to keep the UI responsive; a model name can still be entered manually.",
        ...
        # === ASRLabs Integration ===
        "settings_asr_provider_label": "🧩 Recognition Provider",
        "settings_asr_provider_asrlabs": "ASRLabs (PyTorch / HuggingFace)",
        "settings_asr_provider_crispasr": "CrispASR (Local GGUF)",
        ...
        "settings_crispasr_backend_label": "🧠 CrispASR Backend",
        "settings_crispasr_model_label": "📦 CrispASR Recognition Model (GGUF)",
        "settings_crispasr_aligner_label": "⏱️ CrispASR Forced Aligner (GGUF)",
        "settings_crispasr_param_label": "🔧 CrispASR Command Template",
        "settings_crispasr_param_placeholder": "Placeholders: $crispasr_executable, $backend, $model_file, $aligner_file, $language, $output_file, $input_file",
        "settings_open_crispasr_btn": "📁 Open CrispASR Directory",
        "settings_refresh_crispasr_btn": "🔄 Refresh CrispASR Lists",
        "status_crispasr_transcribing": "[INFO] [CrispASR] Transcribing: {backend} -> {audio}",
        "status_crispasr_done": "[INFO] [CrispASR] Transcription and alignment complete: {output}",
        "status_crispasr_error": "[ERROR] [CrispASR] Processing failed: {error}",
        "status_crispasr_param_save_error": "[WARN] [CrispASR] Could not save the command template; continuing with the current settings: {error}",
    },
    "ja": {
        "lan_title": "PixelPlayer LAN 接続",
        "lan_enabled": "LAN サービスを有効化",
        ...
        "lan_address": "アドレス：{address}:{port}",
        "lan_pair_code": "ペアリングコード：{code}",
        "lan_restart": "サービスを開始/再起動",
        ...
        "progress_phase_files": "ファイル処理",
        "progress_phase_input": "入力準備",
        "progress_phase_download": "入力ダウンロード",
        "progress_phase_audio": "音声抽出",
        "progress_phase_split": "音声分割",
        "progress_phase_transcribe": "文字起こし・アライン",
        "progress_phase_merge": "セグメント結合",
        "progress_phase_resegment": "AI文分割",
        "progress_phase_subtitle": "字幕生成",
        "progress_phase_translation": "翻訳・校正",
        "progress_phase_output": "最終出力",
        "progress_phase_separate": "ボーカル分離",
        "progress_phase_summarize": "字幕要約",
        "progress_phase_synth": "動画合成",
        "progress_phase_clip": "動画クリップ",
        "progress_phase_clean": "キャッシュ削除",
        "progress_phase_api": "APIテスト",
        "status_ai_resegment_done": "[INFO] AI文分割整理が完了しました（{count}件）。",
        "status_ai_resegment_failed": "[WARN] AIの文分割応答が無効なため、元の分割を保持しました：{error}",
        "status_ai_resegment_unchanged": "[WARN] AIが元と同じグループを返したため、.resegmented ファイルは作成しませんでした。",
        ...
        "adv_ai_resegment_model_label": "🧩 全文分割整理モデル：",
        "adv_proofread_model_label": "✅ 全文校正モデル：",
        "adv_auxiliary_models_label": "🧰 補助処理モデル設定：",
        "tip_auxiliary_profiles": "全文分割整理と全文校正は、メイン翻訳に追従するか、プロバイダー・モデル・APIキー・エンドポイントを個別に設定できます。",
        "aux_profile_follow_main": "メイン翻訳設定に従う",
        "aux_profile_custom": "custom（OpenAI互換）",
        "aux_profile_provider_label": "プロバイダー：",
        "aux_profile_model_label": "モデル：",
        "aux_profile_token_label": "APIキー：",
        "aux_profile_address_label": "APIアドレス：",
        "aux_profile_token_placeholder": "空欄の場合はメインAPIキーを使用",
        "aux_profile_custom_address_placeholder": "OpenAI互換APIアドレスを入力",
        "aux_profile_test_btn": "この設定をテストしてモデル一覧を取得",
        "tip_auxiliary_model_detail": "第2メニュー：具体的なモデルを選択します。カスタムではモデル名を直接入力できます。",
        "tip_ai_resegment_model": "文分割整理は通常Flashで十分です。複雑な長文にはProを使用できます。",
        "tip_proofread_model": "校正精度にはProを推奨します。速度優先ならFlashを選択してください。",
        "adv_deepseek_thinking": "メイン翻訳で思考モードを有効化",
        "tip_deepseek_thinking": "メインモデルの推論リクエストのみを制御します。処理時間とToken消費が増えます。",
        "aux_profile_thinking": "思考モードを有効化",
        "tip_aux_profile_thinking": "現在の補助処理のみを制御します。思考をサポートしないモデルでは有効化できません。",
        "dialog_model_target_label": "選択モデルの用途：",
        "dialog_model_target_translation": "メイン翻訳",
        "dialog_model_target_resegment": "全文分割整理",
        "dialog_model_target_proofread": "全文校正",
        "adv_concurrency_label": "最大同時実行数（0=直列、1以上=並列）：",
        "adv_online_token_label": "🚀 オンラインモデルトークン",
        "adv_translator_mode_online": "オンライン API",
        "adv_translator_mode_local": "ローカルモデル",
        ...
        "offline_test_requires_crispasr": "オフライン文字起こしのセルフテストは現在 CrispASR のみ対応しています",
        ...
        "status_aux_models_loaded": "[INFO] {count}モデルを読み込みました。対応するモデル欄から選択してください。",
        "status_api_models_truncated": "[WARN] APIから{total}モデルが返されました。UIの応答性を保つため先頭{limit}件のみ読み込みました。モデル名は手動入力も可能です。",
        ...
        # === ASRLabs Integration ===
        "settings_asr_provider_label": "🧩 音声認識プロバイダー",
        "settings_asr_provider_asrlabs": "ASRLabs（PyTorch / HuggingFace）",
        "settings_asr_provider_crispasr": "CrispASR（ローカル GGUF）",
        ...
        "settings_crispasr_backend_label": "🧠 CrispASR バックエンド",
        "settings_crispasr_model_label": "📦 CrispASR 音声認識モデル（GGUF）",
        "settings_crispasr_aligner_label": "⏱️ CrispASR 強制アライメントモデル（GGUF）",
        "settings_crispasr_param_label": "🔧 CrispASR コマンドテンプレート",
        "settings_crispasr_param_placeholder": "プレースホルダー：$crispasr_executable、$backend、$model_file、$aligner_file、$language、$output_file、$input_file",
        "settings_open_crispasr_btn": "📁 CrispASR フォルダーを開く",
        "settings_refresh_crispasr_btn": "🔄 CrispASR リストを更新",
        "status_crispasr_transcribing": "[INFO] [CrispASR] 文字起こし中：{backend} -> {audio}",
        "status_crispasr_done": "[INFO] [CrispASR] 文字起こしとアライメント完了：{output}",
        "status_crispasr_error": "[ERROR] [CrispASR] 処理失敗：{error}",
