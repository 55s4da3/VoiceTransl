...
TRANSLATIONS = {
    "zh": {
        ...
        "adv_deepseek_thinking": "主翻译启用 DeepSeek 思考",
        "tip_deepseek_thinking": "只控制主翻译的 DeepSeek V4 请求；会增加耗时与 Token 消耗。",
        "aux_profile_thinking": "启用 DeepSeek 思考",
        "tip_aux_profile_thinking": "只控制当前辅助流程；非 DeepSeek V4 模型不会发送 thinking 参数。",
    ...
    "en": {
        ...
        "adv_deepseek_thinking": "DeepSeek thinking for main translation",
        "tip_deepseek_thinking": "Controls only main DeepSeek V4 translation requests; this increases latency and token usage.",
        "aux_profile_thinking": "Enable DeepSeek thinking",
        "tip_aux_profile_thinking": "Controls only this auxiliary process; non-DeepSeek V4 models do not receive a thinking parameter.",
    ...
    "ja": {
        ...
        "adv_deepseek_thinking": "メイン翻訳でDeepSeek思考を有効化",
        "tip_deepseek_thinking": "メイン翻訳のDeepSeek V4リクエストのみを制御します。処理時間とToken消費が増えます。",
        "aux_profile_thinking": "DeepSeek思考を有効化",
        "tip_aux_profile_thinking": "現在の補助処理のみを制御します。DeepSeek V4以外にはthinkingパラメーターを送信しません。",
