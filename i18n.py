...
TRANSLATIONS = {
    "zh": {
        ...
        "dictionary_presets_title": "📚 本地预设库",
        "dictionary_preset_name_label": "📛 预设名称",
        "dictionary_preset_save": "保存预设",
        "dictionary_preset_load": "读取预设",
        "dictionary_preset_refresh": "刷新预设列表",
        "dictionary_preset_open_dir": "打开预设目录",
        "dictionary_preset_name_required": "请输入预设名称",
        "dictionary_preset_saved": "[INFO] 字典预设“{name}”已保存。",
        "dictionary_preset_loaded": "[INFO] 字典预设“{name}”已读取。",
        "dictionary_preset_save_error": "[ERROR] 保存字典预设失败：{error}",
        "dictionary_preset_load_error": "[ERROR] 读取字典预设失败：{error}",
        "config_theme_label": "🎨 界面主题",
        "theme_light_blue": "浅色 · 蓝色",
        "theme_light_teal": "浅色 · 青色",
        "theme_light_purple": "浅色 · 紫色",
        "theme_dark_blue": "深色 · 蓝色",
        "theme_dark_teal": "深色 · 青色",
        "theme_dark_purple": "深色 · 紫色",
        "tools_title": "工具箱",
        ...
        "io_input_label": "📂 输入音视频/SRT文件或视频链接",
        ...
        "io_use_input_dir_checkbox": "🗂️ 输出到音频目录",
        ...
        "io_segment_checkbox": "✂️ 启用音频分段处理",
        "tip_io_segment": "长音频分段后听写翻译再合并。",
        "io_segment_duration_label": "⏱️ 分段时长：",
        ...
        "settings_asr_model_label": "🗣️ 语音识别模型：",
        ...
        "adv_online_address_label": "🚀 在线模型API地址",
        ...
        "synth_subtitle_type_label": "🎞️ 字幕类型",
        "synth_sub_hard": "硬字幕",
        "synth_sub_soft": "软字幕",
        "synth_font_label": "🅰️ 字体选择",
        "synth_run_btn": "🚀 字幕合成",
    ...
    "en": {
        ...
        "workflow_subtitle": "Handle input, speech recognition, translation, and output on one page. Runtime information appears in the shared area below.",
        ...
        "config_subtitle": "Manage speech recognition, forced alignment, separation, and translation models/APIs. Changes save automatically.",
        ...
        "dictionary_subtitle": "Edit dictionaries used at each translation stage and save common combinations in project/dictionary_presets.",
        "dictionary_presets_title": "📚 Local preset library",
        "dictionary_preset_name_label": "📛 Preset name",
        "dictionary_preset_save": "Save preset",
        "dictionary_preset_load": "Load preset",
        "dictionary_preset_refresh": "Refresh presets",
        "dictionary_preset_open_dir": "Open preset folder",
        "dictionary_preset_name_required": "Enter a preset name",
        "dictionary_preset_saved": "[INFO] Dictionary preset “{name}” saved.",
        "dictionary_preset_loaded": "[INFO] Dictionary preset “{name}” loaded.",
        "dictionary_preset_save_error": "[ERROR] Failed to save dictionary preset: {error}",
        "dictionary_preset_load_error": "[ERROR] Failed to load dictionary preset: {error}",
        "config_theme_label": "🎨 Interface theme",
        "theme_light_blue": "Light · Blue",
        "theme_light_teal": "Light · Teal",
        "theme_light_purple": "Light · Purple",
        "theme_dark_blue": "Dark · Blue",
        "theme_dark_teal": "Dark · Teal",
        "theme_dark_purple": "Dark · Purple",
        "tools_title": "All Tools",
        "tools_subtitle": "Clip and separate vocals, synthesize media, and summarize subtitles from one page.",
        ...
        "status_task_busy": "[WARNING] Another task is already running. Wait for it to finish or cancel it first.",
        ...
        "io_input_label": "📂 Input audio/video/SRT files or video links",
        "tip_io_input": "Supports local audio/video/SRT files, Bilibili BV numbers, YouTube URLs, and other video links, one per line.",
        "io_input_placeholder": "Example: C:/video.mp4 or https://www.youtube.com/watch?v=... or BV1Lxt5e8EJF",
        "io_proxy_label": "🌐 Proxy address:",
        ...
        "io_use_input_dir_checkbox": "🗂️ Output to audio directory",
        ...
        "io_segment_checkbox": "✂️ Enable audio segment processing",
        "tip_io_segment": "Split long audio for transcription/translation, then merge.",
        "io_segment_duration_label": "⏱️ Segment duration:",
        ...
        "dict_prompt_mode_label": "📝 Extra prompt mode",
        ...
        "settings_asr_model_label": "🗣️ Speech recognition model:",
        ...
        "tip_settings_lang": "ja=Japanese, en=English, ko=Korean, ru=Russian, fr=French, zh=Chinese",
        ...
        "adv_concurrency_label": "Max concurrency:",
        ...
        "adv_online_address_label": "🚀 Online Model API Address",
        ...
        "tip_adv_offline_param": "Space-separated parameters, see Llama.cpp docs. Leave default if unsure.",
        ...
        "synth_subtitle_type_label": "🎞️ Subtitle Type",
        "synth_sub_hard": "Hard Subtitle",
        "synth_sub_soft": "Soft Subtitle",
        "synth_font_label": "🅰️ Font Selection",
    ...
    "ja": {
        ...
        "dictionary_presets_title": "📚 ローカルプリセット",
        "dictionary_preset_name_label": "📛 プリセット名",
        "dictionary_preset_save": "プリセットを保存",
        "dictionary_preset_load": "プリセットを読み込む",
        "dictionary_preset_refresh": "一覧を更新",
        "dictionary_preset_open_dir": "プリセットフォルダーを開く",
        "dictionary_preset_name_required": "プリセット名を入力してください",
        "dictionary_preset_saved": "[INFO] 辞書プリセット「{name}」を保存しました。",
        "dictionary_preset_loaded": "[INFO] 辞書プリセット「{name}」を読み込みました。",
        "dictionary_preset_save_error": "[ERROR] 辞書プリセットの保存に失敗しました：{error}",
        "dictionary_preset_load_error": "[ERROR] 辞書プリセットの読み込みに失敗しました：{error}",
        "config_theme_label": "🎨 画面テーマ",
        "theme_light_blue": "ライト・ブルー",
        "theme_light_teal": "ライト・ティール",
        "theme_light_purple": "ライト・パープル",
        "theme_dark_blue": "ダーク・ブルー",
        "theme_dark_teal": "ダーク・ティール",
        "theme_dark_purple": "ダーク・パープル",
        "tools_title": "すべてのツール",
        ...
        "io_input_label": "📂 音声/動画/SRTファイルまたは動画リンクを入力",
        ...
        "io_segment_checkbox": "✂️ 音声セグメント処理を有効化",
        "tip_io_segment": "長い音声を分割して文字起こし・翻訳後に結合。",
        "io_segment_duration_label": "⏱️ セグメント長：",
        ...
        "dict_prompt_mode_label": "📝 追加プロンプトモード",
        ...
        "settings_asr_model_label": "🗣️ 音声認識モデル：",
        ...
        "adv_online_address_label": "🚀 オンラインモデルAPIアドレス",
        ...
        "adv_offline_param_label": "💻 オフラインモデルパラメータ",
        ...
        "synth_subtitle_type_label": "🎞️ 字幕タイプ",
        "synth_sub_hard": "焼き字幕",
        "synth_sub_soft": "ソフト字幕",
        "synth_font_label": "🅰️ フォント選択",
        "synth_run_btn": "🚀 字幕合成",
