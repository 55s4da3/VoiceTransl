...
## 当前状态
- 分支 `feat/qwen-streaming-integration`；上游整合、OpenCode Go 与 DeepSeek 官方 V4 Flash（用户称 V4.1）适配均已提交，并按用户要求推送到 `origin` 同名分支。
